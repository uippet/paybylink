        ...
        <div class="row">
          <div class="col-lg-12">
           ...
           <div class="col-lg-6"> 
				...
				?>
			<form role="form" method="POST" action="<?php echo site_url('api/edit/'.$api->api_id); ?>">
			<input type="hidden" name="api_id" value="<?php echo $api->api_id; ?>" />
              ...
              <div class="form-group">
                ...
                <input class="form-control" name="api_name" value="<?php echo $api->api_name;?>"/>
				<?php echo form_error('api_name'); ?>
              </div>
			  
			   <div class="form-group">
                <label>Where you will use the API</label>
                <input class="form-control" name="where_used" value="<?php echo $api->where_used;?>"/>
				<?php echo form_error('where_used'); ?>
              </div>
              
              <div class="form-group">
                <label>API Type</label><br />
                <input type="radio" name="api_type" class="api_type" value="email" <?php echo ($api->api_type == 'email') ? 'checked' : ''; ?>/> Email <br />
                <input type="radio" name="api_type" class="api_type" value="iframe" <?php echo ($api->api_type == 'iframe') ? 'checked' : ''; ?>/> Iframe <br />
				<?php echo form_error('api_type'); ?>
              </div>
			  
			  <div class="form-group">
                <label>Recurrent</label><br />
                <input type="radio" name="recurrent"  class="recurrent" value="1" <?php echo ($api->recurrent) ? 'checked' : ''; ?>/> Yes  <span  id="recurrent_days" <?php echo ($api->recurrent) ? '' : 'style="display:none"'; ?> >Every <input type="text" name="recurrent_days" value="<?php echo $api->recurrent_days; ?>" /> Days</span> <br />
                <input type="radio" name="recurrent" class="recurrent" value="0"  <?php echo (!$api->recurrent) ? 'checked' : ''; ?>/> No <br />
				<?php echo form_error('recurrent'); ?>
				 ...
				 <div class="col-lg-6">
				  <div class="form-group">
	                ...
	                <input type="text" name="api_key" value="<?php echo $api->api_key;?>" class="form-control" /> 
	              ...
	              <div class="form-group">
	               ...
	               <button type="submit" class="btn btn-large btn-success" name="updateapibtn" value="New api">Edit API</button>
