...
?>
	...
	?>
	  <tr class="transaction-row">
		...
		<td><?php echo ucwords($payment['client_email']);?></td>
		<td><?php echo ucwords($payment['client_phone']);?></td>
		<td class="text-right"><span class="label label-<?php echo ($payment['payment_status'] == 'pending') ? 'danger' : 'success' ; ?>"><?php echo ucwords($payment['payment_status']);?></span></td>
		<td class="text-right"><?php echo $currency_symbol.number_format($payment['payment_amount'], 2); ?></td>
	  </tr>
	<?php
